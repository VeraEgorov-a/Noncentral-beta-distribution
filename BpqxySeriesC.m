function [betanc, ier]=BpqxySeriesC(x,y,p,q)
%Implementation of the series in terms of the central beta distribution
%We use our algorithm to compute the central beta distribution
eps=1.e-15;
Nmax=1000;
r= p + q; 
c=r-1;
