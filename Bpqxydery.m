function [Bdy,ierr]=Bpqxydery(x,y,p,q)
%--------------------------------------------------------
%Noncentral beta: derivative with respect to y
%We use the expression in terms of the Kummer-M function
%--------------------------------------------------------
ierr=0;
if y<1e-300
  Bdy=0;
